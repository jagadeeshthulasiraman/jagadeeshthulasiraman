...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Jagadeesh%20Thulasiraman&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Python%20Backend%20Developer%20%7C%20FastAPI%20%7C%20Building%20Real-Time%20Systems&descAlignY=62&descSize=16" width="100%"/>
...
class BackendDeveloper:
    def __init__(self):
        self.name = "Jagadeesh Thulasiraman"
        ...
        self.currently_learning = ["System Design", "PostgreSQL", "Kubernetes"]
        self.fun_fact = "I've interned at 2 TATA Group companies before graduating!"

    def motto(self):
        return "Ship clean APIs, monitor everything, sleep well at night."
...
<details>
<summary><b>Projects & Maintenance Intern — Titan Company Ltd, Jewellery Division (TATA Enterprise)</b> | Jun 2024</summary>
<br/>

- Assisted the Projects & Maintenance department at a large-scale jewellery manufacturing facility, supporting active engineering initiatives.
- Coordinated across 3+ cross-functional teams to document and track maintenance schedules for 10+ ongoing projects, reducing coordination gaps.

</details>

<details>
<summary><b>Engineering & Automation Intern — Titan Engineering & Automation Ltd (TATA)</b> | Jun 2023</summary>
<br/>

- Completed structured industrial automation training; performance formally rated **GOOD** by HR management.
- Gained hands-on exposure to automation systems and equipment, building a foundation for system-level engineering work.

</details>

<details>
<summary><b>AWS Cloud Intern — Technosaign</b> | Jun 2023</summary>
<br/>

- Completed structured AWS training covering EC2, S3, and IAM.
- Applied core cloud concepts to deploy and manage cloud resources.
...
| CSS | HackerRank | May 2025 |
| Python | HackerRank | Sep 2024 |
...
**B.E., Electronics & Communication Engineering** — Adhiyamaan College of Engineering, Hosur *(May 2025, CGPA: 7.1/10)*
**Higher Secondary (HSC)** — Sri Vijaya Vidyalaya Matric Hr. Sec. School, Hosur *(May 2021, 82%)*

## 📚 Currently Learning

`System Design` · `PostgreSQL` · `Kubernetes`
